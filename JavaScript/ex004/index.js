...
//   poderDeAtaque: prompt("Qual seu poder de ataque"),
// };

// const personagemDois = {
//   nome: prompt("Insira o nome do personagem 2?"),
//   pontosVida: prompt("Quantos pontos de vida?"),
//   poderDefesa: prompt("Qual seu poder de defesa"),
//   escudo: prompt("O personagem possui escudo?"),
// };
...
//   if (personagemUm.poderDeAtaque > personagemDois.poderDefesa) {
//     if (!personagemDois.escudo) {
//       dano = personagemUm.poderDeAtaque - personagemDois.poderDefesa;
//     } else {
//       dano = (personagemUm.poderDeAtaque - personagemDois.poderDefesa) / 2;
//     }
//   }

//   personagemDois.pontosVida -= dano; 

//   alert(`Dano causado: ${dano}\n` + 
//   `\nPersonagem 1: ${personagemUm.nome}` +
//   `\nPoder de ataque: ${personagemUm.poderDeAtaque}` + 
//   `\nPersonagem 2: ${personagemDois.nome}` + `\nPontos de vida: ${personagemDois.pontosVida}, Poder de defesa: ${personagemDois.poderDefesa}, Escudo: ${personagemDois.escudo}`)
// }
